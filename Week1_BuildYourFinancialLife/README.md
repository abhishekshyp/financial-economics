...
It ships in two forms: a self-contained **web app** for exploration and demonstration, and a **transparent spreadsheet** for inspecting the mechanics formula by formula.
